defmodule MysqrftWeb.Components.CheckboxCard do
  @moduledoc """
  The `MysqrftWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
