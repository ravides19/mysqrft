defmodule MysqrftWeb.Components.Overlay do
  @moduledoc """
  The `MysqrftWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `MysqrftWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
