defmodule MysqrftWeb.Components.Alert do
  @moduledoc """
  MysqrftWeb.Components.Alert module provides collection of alert components and helper functions for managing and displaying alerts
