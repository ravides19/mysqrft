defmodule MysqrftWeb.Components.Divider do
  @moduledoc """
  The `MysqrftWeb.Components.Divider` module provides a versatile and customizable divider
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/divider
  ...
  @doc """
  `MysqrftWeb.Components.Divider.hr` is used to create a horizontal divider with customizable style, color,
  and size options.
