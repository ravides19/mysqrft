defmodule MySqrftWeb.Live.Components.EmailFieldLive do
  @moduledoc """
  LiveView showcasing EmailField component variations.
  """
  ...
  def render(assigns) do
    ...
    <Layouts.app flash={@flash}>
      <div class="space-y-12">
        <div>
          <h1 class="text-4xl font-bold mb-2">Email Field Component</h1>
          <p class="text-lg text-gray-600 dark:text-gray-400">
            Explore all email field variations and colors
          </p>
        </div>
