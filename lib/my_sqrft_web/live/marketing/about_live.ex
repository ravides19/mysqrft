    ...
    {:ok,
     ...
     |> assign(:values, [
       %{
         title: "Trust First",
         description:
           "We verify every listing and user because trust is the foundation of every successful rental.",
         icon: "hero-shield-check"
       },
       %{
         title: "User Obsessed",
         description:
           "Every feature we build starts with understanding and solving real user problems.",
         icon: "hero-heart"
       },
       %{
     ...
     |> assign(:milestones, [
       %{
         year: "2024",
         title: "The Beginning",
         description: "Founded with a mission to transform India's rental experience."
       },
       %{
         year: "2025",
         title: "Rapid Growth",
         description: "Expanded to 50+ cities with 25,000+ verified listings."
       },
       %{
         year: "2026",
         title: "Market Leader",
         description: "Serving 2M+ users across 100+ Indian cities."
       }
     ])}
  end
  ...
  def render(assigns) do
    ...
    <div class="relative overflow-hidden">
      ...
      <section class="relative py-20 md:py-32 grain-overlay">
        ...
        <div class="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-red-100/50 to-transparent dark:from-red-900/10">
        </div>
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="max-w-3xl">
            ...
            <h1 class="font-display text-5xl md:text-6xl font-bold text-gray-900 dark:text-white leading-tight mb-6">
              Making Home Finding <span class="text-gradient">Personal Again</span>
            </h1>
              ...
              <div class="aspect-square bg-gradient-to-br from-red-100 to-red-100 dark:from-gray-800 dark:to-gray-700 rounded-3xl overflow-hidden">
                <div class="absolute inset-0 flex items-center justify-center">
                  <div class="text-center">
                    ...
                    <div class="font-display text-2xl font-bold text-gray-900 dark:text-white">
                      MySqrft
                    </div>
    ...
    <!-- Decorative elements -->
              <div class="absolute -top-4 -right-4 w-24 h-24 bg-red-200 dark:bg-red-800/30 rounded-2xl -z-10">
              </div>
              <div class="absolute -bottom-4 -left-4 w-32 h-32 bg-red-200 dark:bg-red-800/30 rounded-3xl -z-10">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <.card
              ...
              rounded="extra_large"
              padding="extra_large"
              class="text-center group hover:border-primary-light dark:hover:border-primary-dark transition-all duration-300"
            >
              ...
              <h3 class="font-display text-xl font-bold text-gray-900 dark:text-white mb-3">
                {value.title}
              </h3>
    ...
    <!-- Timeline Section -->
      <section class="py-20 md:py-32 bg-gray-50 dark:bg-gray-900">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="relative">
            <!-- Timeline line -->
            <div class="hidden md:block absolute left-1/2 transform -translate-x-1/2 h-full w-0.5 bg-red-200 dark:bg-red-800">
            </div>
            ...
            <div class="space-y-12">
              ...
              >
                <!-- Timeline dot -->
                <div class="hidden md:block absolute left-1/2 transform -translate-x-1/2 w-4 h-4 bg-[#FF385C] rounded-full border-4 border-red-50 dark:border-gray-900">
                </div>
      ...
      <section class="py-20 md:py-32 bg-gradient-to-br from-[#FF385C] to-[#FF5A5F] relative overflow-hidden">
        ...
        <div class="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/users/register"
              class="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-[#FF385C] bg-white rounded-xl hover:bg-red-50 shadow-xl shadow-red-900/20 transition-all"
            >
              Start Your Search
            </a>
            <a
              href="#"
              class="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-white border-2 border-white/50 rounded-xl hover:bg-white/10 transition-all"
            >
              View Careers
            </a>
          </div>
