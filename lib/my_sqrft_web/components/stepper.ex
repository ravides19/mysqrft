defmodule MySqrftWeb.Components.Stepper do
  @moduledoc """
  The `MySqrftWeb.Components.Stepper` module provides a flexible and interactive stepper component
  ...
  The `MySqrftWeb.Components.Stepper` enhances user experience by providing a clear and concise representation
