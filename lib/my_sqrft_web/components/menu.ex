defmodule MySqrftWeb.Components.Menu do
  @moduledoc """
  The `MySqrftWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `MySqrftWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/menu
  ...
  import MySqrftWeb.Components.Button, only: [button_link: 1]
