defmodule MySqrftWeb.Components.NativeSelect do
  @moduledoc """
  The `MySqrftWeb.Components.NativeSelect` module provides a customizable native select component
  ...
  With built-in error handling and custom error messages, `MySqrftWeb.Components.NativeSelect`
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/forms/native-select
  ...
  defp translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MySqrftWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MySqrftWeb.Gettext, "errors", msg, opts)
    end
  end
end
