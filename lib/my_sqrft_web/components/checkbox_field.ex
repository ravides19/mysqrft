defmodule MySqrftWeb.Components.CheckboxField do
  @moduledoc """
  MySqrftWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
