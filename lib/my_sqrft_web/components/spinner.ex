defmodule MySqrftWeb.Components.Spinner do
  @moduledoc """
  The `MySqrftWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `MySqrftWeb.Components.Spinner` module enables developers to provide
