defmodule MySqrftWeb.Components.ScrollArea do
  @moduledoc """
  The `MySqrftWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
