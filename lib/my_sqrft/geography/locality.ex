defmodule MySqrft.Geography.Locality do
  @moduledoc """
  Locality schema for geographic hierarchy with geospatial data.
  """
  use Ecto.Schema
  import Ecto.Changeset
  alias MySqrft.Geography.{City, LocalityAlias, Pincode, Landmark}
  ...
  schema "localities" do
    ...
    has_many :locality_aliases, LocalityAlias
    has_many :pincodes, Pincode
    has_many :landmarks, Landmark
  ...
  def changeset(locality, attrs) do
    locality
    |> cast(attrs, [:name, :name_alt, :latitude, :longitude, :location, :boundary, :status, :metadata, :city_id])
