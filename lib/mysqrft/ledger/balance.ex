defmodule Mysqrft.Ledger.Balance do
  use Ash.Resource,
  ...
  balance do
    transfer_resource Mysqrft.Ledger.Transfer
  ...
  relationships do
    belongs_to :transfer, Mysqrft.Ledger.Transfer do
      attribute_type AshDoubleEntry.ULID
      allow_nil? false
      attribute_writable? true
    end

    belongs_to :account, Mysqrft.Ledger.Account do
      allow_nil? false
      attribute_writable? true
    end
  end
