defmodule Mysqrft.Repo.Migrations.InitializeAndAddAuthenticationResourcesAndAddPasswordAuthenticationAndAddPasswordAuthAndAddMagicLinkAuthAndInstallAshMoneyAndAddLedgerExtensions1 do
  @moduledoc """
