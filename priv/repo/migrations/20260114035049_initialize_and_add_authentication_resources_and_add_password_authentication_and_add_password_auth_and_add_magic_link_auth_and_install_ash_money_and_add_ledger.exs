defmodule Mysqrft.Repo.Migrations.InitializeAndAddAuthenticationResourcesAndAddPasswordAuthenticationAndAddPasswordAuthAndAddMagicLinkAuthAndInstallAshMoneyAndAddLedger do
  @moduledoc """
