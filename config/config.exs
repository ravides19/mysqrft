...
config :ex_cldr, default_backend: Mysqrft.Cldr
...
config :mysqrft,
  ...
  ash_domains: [Mysqrft.Ledger, Mysqrft.Accounts],
...
config :mysqrft, MysqrftWeb.Endpoint,
  ...
  live_view: [signing_salt: "ZV7e2nYK"]
...
config :mysqrft, Mysqrft.Mailer, adapter: Swoosh.Adapters.Local
